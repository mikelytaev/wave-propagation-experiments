...
expected_env.knife_edges = [
    KnifeEdge(range=-195, height=72),
    KnifeEdge(range=1296, height=67),
]
calc(src=antenna, true_env=true_env, expected_env=expected_env, range_bounds_m=[-500, 1500], measures=measures,
