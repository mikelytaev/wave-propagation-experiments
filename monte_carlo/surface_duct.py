...
environment.M_profile = lambda x, z: surface_duct(height_m=expected_height, strength=20, z_grid_m=z)
...
for height in heights:
    print(height)
    environment.M_profile = lambda x, z: surface_duct(height_m=height, strength=20, z_grid_m=z)
...
vis_error = FieldVisualiser(error, env=environment, trans_func=lambda v: v, label='Pade + Transparent BC', x_mult=1E-3)
