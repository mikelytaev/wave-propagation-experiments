...
import optimization.uwa.pade_opt.utils

pyximport.install(setup_args={"include_dirs": np.get_include()}, language_level=3)

from jcs.d2_error import *
import math as fm
...
xi = -0.4
error = optimization.uwa.pade_opt.utils.tau_error(xi, xi, dx_wl, pade_coefs_num, pade_coefs_den, a0)
