...
f, ax = plt.subplots(1, 1, figsize=(6, 3.2), constrained_layout=True)
ylim = [0.01, 100]
ax.plot(linear_opt_res.ground_truth_errors, label="Piecewise linear", color="blue", linestyle="-")
ax.plot(mlp_opt_res.ground_truth_errors[0:250], label="MLP (l=4; w=50)", color="red", linestyle="-")
ax.set_xlim([1, 10000])
ax.set_ylim(ylim)
...
f, ax = plt.subplots(1, 1, figsize=(6, 3.2), constrained_layout=True)
ylim = [0.01, 100]
ax.plot(linear_opt_res.loss_vals, label="Piecewise linear", color="blue", linestyle="-")
ax.plot(mlp_opt_res.loss_vals[0:250], label="MLP (l=4; w=50)", color="red", linestyle="-")
ax.set_xlim([1, 10000])
ax.set_ylim(ylim)
ax.set_xlabel("Iteration number")
ax.set_ylabel("Loss")
