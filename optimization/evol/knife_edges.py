...
bounds_ga = [(dx_joined_pade, 10), (dz_joined_pade, 3)] + [(-1000, 1000)] * (order[0] + order[1]) * 2
...
ant = GaussAntenna(freq_hz=300e6, height=1500, beam_width=3, elevation_angle=0, polarz='H')
